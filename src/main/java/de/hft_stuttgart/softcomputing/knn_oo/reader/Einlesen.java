package de.hft_stuttgart.softcomputing.knn_oo.reader;
		...
		public static double[][] einlesenVorlesungsbeispiele(File file) {
			...
			try{
	            ...
	            while(scanner.hasNext()) {
	            	...
	            	//um sie beim de.hft_stuttgart.softcomputing.knn_oo.reader.Einlesen auf den Bereich [0, 1] zu skalieren
	            	dim++;
	            } 
	            scanner.close();
